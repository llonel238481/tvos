<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <!-- 🧭 Heading -->
            <div>
                <h1 class="text-3xl font-bold mb-2">Supervisor Dashboard</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="stats shadow-lg bg-base-100">
                    <div class="stat">
                        <div class="stat-title">Department Travel Orders</div>
                        <div class="stat-value text-primary">{{ $deptTravelOrders }}</div>
                        <div class="stat-desc">Dept: {{ Auth::user()->department->name ?? 'N/A' }}</div>
                    </div>
                </div>
